function WaterRipple(ctx, width, height) {
    ...
    self.start = function() {
        ...
        setInterval(self.process, delay);
    }
    
    
    self.disturb = function(x, y, z){
    ...
    self.process = function(){
        ...
        // rain
        // self.disturb(floor(Math.random()*width), floor(Math.random()*height), Math.random()*10000);
        aux = buffer0;
        buffer0 = buffer1;
        buffer1 = aux;
